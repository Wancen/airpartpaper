...
First, we load the preprocessed [Deng 2014](https://science.sciencemag.org/content/343/6167/193.long) data. It includes one maternal allelic counts(`cast`) and paternal allelic counts(`b6`) which was derived after removing some low quality cells indicated in the previous paper. `celltype` is a character vector of all cell types.
...
assay.list<-list(a1=cast[,order_of_development],a2=b6[,order_of_development])
